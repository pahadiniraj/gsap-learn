<div >
 ...
 <h3 style="font-weight:700;font-size:30px;">Learn GSAP</h3>
...
```bash
# 1. Clone the repo
git clone [https://github.com/pahadiniraj/gsap-learn.git](https://github.com/pahadiniraj/gsap-learn.git)
